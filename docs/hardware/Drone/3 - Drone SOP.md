...
9. Write the waypoints to the drone when it's connected to the Mission Planner Software.
...
6. Open the Mission Planner Application.

   ![Image title](_attachments/Screenshot_2024-03-15_at_1.20.14_PM.jpg)

7. Select AUTO and Click Connect. It will automatically scan the port and find the USB radio module.

   ![Image title](_attachments/Screenshot_2024-03-15_at_4.58.47_PM.jpg)

8. Now you can see the location and status of the drone.

   ![Image title](_attachments/Pasted_image_20240315193639.jpg)

9. Press the hardware safety switch to activate the drone.

   ![Image title](_attachments/20240302_123729.jpg)
   
   ![Image title](_attachments/Pasted_image_20240315194055.jpg)

10. Arm the motors by pressing the left stick to the lower right corner and hold it.
...
12. To disarm the motors after the flight, press the left stick to the lower left corner and hold it.
...
![](attachment/635da8d8b8421e89cc7b3a9a9e94f907.jpg)

![](attachment/9cd93fb57f4d462eec5fe2af3b25d5d8.png)

### Battery Storage Mode

Lithium polymer batteries used in drones should not be stored for more than a week in a fully discharged or fully charged state, as this can shorten battery lifespan and cause malfunctions. Therefore, when storing drone batteries for an extended period without use, it is recommended to charge or discharge each cell to the storage voltage of 3.8V. 

On the charger, press the ▶️ button to make the charger mode setting blink, then press the (-) or (+) button to switch from Balance CHG to Storage mode. Next, press and hold the ▶️ button to enter Storage mode.

![](attachment/2cf1fe7e7833d77d1f792e052912298c.jpg)

## Why Are Drone Flight Logs Needed?

Images collected from the drone contain the camera's GPS information in the EXIF data. However, to use more accurate GPS information and altitude data, you can use the drone's Flight log. Drone altitude information is measured using a down-facing LiDAR, which is useful for image alignment and predicting GSD. The GEMINI-App utilizes drone logs to synchronize the timestamp of images captured by the drone with the GPS timestamps in the log, replacing the image's original GPS information with the drone's GPS coordinates and altitude data.

## How to Download Drone Flight Log

After the flight, you can connect Mission Planner to download the log.

1. Connect the drone to the computer using a USB cable.

   ![](attachment/f51d12528ec2081a63e9b3785a65dc63.jpg)

2. Launch the Mission Planner app.

   ![](attachment/a3220a62e192c57a08a3423c25f28126.jpg)

3. Press the CONNECT button to connect to the drone.

   ![](attachment/f7f0bbdb094d0b83d7561fc5ec2130d7.jpg)

4. Select the "DataFlash Logs" tab and press the "Download DataFlash Log Via Mavlink" button.

   ![](attachment/706dd8490bbd3ad4cf24204883e9afa6.jpg)

5. When the Log Downloader window appears, (1) check the logs to download and (2) select Download Selected Logs to download. Check the right-side "Output:" to confirm that the log download is complete.

   ![](attachment/aaf6ac0d1c3fb9be740c84321e202187.jpg)

6. The downloaded log can be found at C:\Users\PAIBL\Documents\Mission Planner\logs\QUADROTOR\1.

   ![](attachment/2f391df41ae84016ca041cfc92bb85ea.jpg)

7. Upload the downloaded log using the GEMINI-App. Select the logs with the extension *.bin that correspond to the date of the drone images to upload.

   ![](attachment/55306776f24177e8cfe0981e20da463d.jpg)
   
   ![](attachment/6591a2d3431f387c81c06ecd4ef808fc.png)
   
   ![](attachment/acf32d83c5358596cd8d838b86933574.png)
   
   ![](attachment/9cdabc965567f06566e8d7b0c0e752e3.png)